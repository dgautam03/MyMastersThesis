...
HD_PWD='C:/Users/samyt/DG_Reversible_XOR/DG_Reversible_XOR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reversible_halfaddertb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reversible_halfaddertb.tcl
