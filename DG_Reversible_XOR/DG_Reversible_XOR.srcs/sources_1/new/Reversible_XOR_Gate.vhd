...
end Reversible_XOR_Gate;

architecture FSM of Reversible_XOR_Gate is
type state_type is(s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,s11,E1);
...
pre_A<='1';pre_B<='1';pre_C<='0';Error<='0';
